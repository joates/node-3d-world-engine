  ...
  return (function() {
    ...
    for (var i = 0, il = bbox.length-1; i < il; i++) {
      ...
      geometry.vertices.push(
          new THREE.Vector3(v1[0], 0, v1[1])
        , new THREE.Vector3(v2[0], 0, v2[1])
      )
    }
    return { type: 'line', vertices: geometry.vertices }
  ...
  return (function() {
    ...
    region.edges.forEach(function(edge) {
      ...
      if ((! is_boundary) || is_welded) {
        ...
        geometry.vertices.push(
            new THREE.Vector3(v1_x, origin.y, v1_z)
          , new THREE.Vector3(v2_x, origin.y, v2_z)
        )
      }
