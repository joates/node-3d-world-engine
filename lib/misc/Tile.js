      ...
      map_tile.regions.forEach(function(region, region_id) {
        ...
        if (is_boundary && (! is_welded)) {
          ...
          if (opts.edges_to_repair.indexOf(edge_id) !== -1) {
            ...
            // encode_welded_boundary_neighbors(region, tile_key, all_keys, all_tiles, weld)
          }
        }
...
function encode_welded_boundary_neighbors(region, tile_key, all_keys, all_tiles, weld) {
  // @TODO:
}
