...
exports.render = render_map_tile
var biomes = require('./biomes')
  , map_floor_level = 0

function render_map_tile(tile, THREE) {
  return (function() {
    ...
    tile.regions.forEach(function(region, id) {
      ...
      var origin = new THREE.Vector3(region.center.position.x + tile_offset.x, map_floor_level, region.center.position.z + tile_offset.z)
        , num_verts = 0
      ...
      if (region.boundary && (! region.welded)) {
        ...
        region.edges.forEach(function(edge) {
          ...
          geo.vertices.push(
              new THREE.Vector3(region.vertices[edge.voronoi_verts[0]].x + tile_offset.x, map_floor_level, region.vertices[edge.voronoi_verts[0]].z + tile_offset.z)
            , new THREE.Vector3(region.vertices[edge.voronoi_verts[1]].x + tile_offset.x, map_floor_level, region.vertices[edge.voronoi_verts[1]].z + tile_offset.z)
          )
        ...
        region.edges.forEach(function(edge) {
          ...
          var v1  = new THREE.Vector3(region.vertices[edge.voronoi_verts[0]].x + tile_offset.x, map_floor_level, region.vertices[edge.voronoi_verts[0]].z + tile_offset.z)
            , v2  = new THREE.Vector3(region.vertices[edge.voronoi_verts[1]].x + tile_offset.x, map_floor_level, region.vertices[edge.voronoi_verts[1]].z + tile_offset.z)
